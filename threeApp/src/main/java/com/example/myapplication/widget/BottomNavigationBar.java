...
public class BottomNavigationBar extends LinearLayout {
    ...
    public static final int DEFAULT_CHECKED_TEXT = 0xff119fec;
...
//    }
     ...
     * @param text
     */
    public void addItemViewold(String text, int textCheckdColor, int textUnCheckColor, int imageCheckedResource, int imageUnCheckedResource) {
    ...
    public void addItemView(int id, Object tag, String text, int textCheckdColor, int textUnCheckColor, int imageCheckedResource, int imageUnCheckedResource) {
        NavigationItem item = new NavigationItem(getContext(), textCheckdColor, textUnCheckColor, imageCheckedResource, imageUnCheckedResource);
        item.setId(id);
        item.setTag(tag);
        item.getmTextView().setText(text);
...
//    }
    ...
    public void addItemView(int id, Object tag, String text,int imageCheckedResource, int imageUnCheckedResource){
        addItemView(id, tag, text,textCheckdColor,textUnCheckColor,imageCheckedResource,imageUnCheckedResource);
    }
