...
public class CheckVerThread extends Thread {
	...
	public CheckVerThread(Context context, DownloadHandler dHandler) {
		this.context = context;
		this.dHandler = dHandler;
	}

	public CheckVerThread(Context context, DownloadHandler dHandler, Version  ver) {
		this.context = context;
		this.dHandler = dHandler;
		this.ver = ver;
	}
